package com.lordgasmic.bff.wine;
...
public class WineController {
    ...
    public Object getWineNotes(@RequestHeader(LordgasmicConstants.LORDGASMIC_AUTH_TOKEN) String token,
    ...
    public Object getWineRating(@RequestHeader(LordgasmicConstants.LORDGASMIC_AUTH_TOKEN) String token,
                                @RequestParam("user") final Optional<String> user,
                                @RequestParam("wineId") final Optional<Integer> wineId) {
